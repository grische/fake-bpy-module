...
cd ${current_dir}
apply_workaround
${blender_bin} --background --factory-startup -noaudio --python ${source_dir}/doc/python_api/sphinx_doc_gen.py --python-exit-code 1 -- --output ${tmp_dir}
revert_workaround
...
${blender_bin} --background --factory-startup -noaudio --python ${SCRIPT_DIR}/gen_modfile/gen_external_modules_modfile.py --python-exit-code 1 -- -m addon_utils -o ${generated_mod_dir}/gen_modules_modfile
${blender_bin} --background --factory-startup -noaudio --python ${SCRIPT_DIR}/gen_modfile/gen_external_modules_modfile.py --python-exit-code 1 -- -m keyingsets_builtins -a -o ${generated_mod_dir}/gen_startup_modfile
